...
Original file is located at
    https://colab.research.google.com/drive/1ZvCm9Kh0XfKeUrd_coTVMwPjGewsmk6P
"""
...
with open("fx_model2_sm.pkl", "rb") as f:
...
# --- Streamlit UI ---
st.title("FX - USD/INR Rate Predictor (2 Months Lag Model")
...
lag_date = pd.to_datetime(user_date) - DateOffset(months=2)   # ✅ corrected to 2 months
...
if lag_date in df['Date'].values:
    ...
    st.warning("Lagged data (2 months prior) not available for this date.")